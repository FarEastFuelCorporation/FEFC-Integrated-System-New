// utils/generatePlasticCreditNumber

const PlasticTransaction = require("../models/PlasticTransaction");

async function generatePlasticCreditNumber(volume) {
  try {
    ...
    const newTransactionId = `FEFC-PCC-IP-${currentYear}${currentMonth}${currentDay}${transactionCounterString}-${volumeString}`;
...
module.exports = generatePlasticCreditNumber;
