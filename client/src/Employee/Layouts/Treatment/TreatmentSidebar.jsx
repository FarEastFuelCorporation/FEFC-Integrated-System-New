...
const TreatmentSidebar = ({ user }) => {
  ...
  const pathToTitleMap = useMemo(
    () => ({
      ...
      "/dashboard/treatmentMachines": "Treatment Machines",
  ...
  return isMobile ? (
    ...
    >
      ...
      >
        ...
        />
        <BottomNavItem
          label="Treatment Machines"
          value="Treatment Machines"
          icon={SettingsSuggestIcon}
          selected={selected}
          setSelected={setSelected}
          navigate={"treatmentMachines"}
        />
        <BottomNavItem
          label="Truck Scale"
          value="Truck Scale"
      ...
      <ProSidebar collapsed={isCollapsed}>
        <Menu iconShape="square" style={{ height: "calc(100vh - 64px)" }}>
          ...
          <Box paddingLeft={isCollapsed ? undefined : "10%"}>
            ...
            <Item
              title="Treatment Machines"
              to="treatmentMachines"
              icon={<SettingsSuggestIcon />}
              selected={selected}
              setSelected={setSelected}
              collapsed={isCollapsed}
