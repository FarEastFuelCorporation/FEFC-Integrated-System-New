        ...
        <IconButton
          ...
          onClick={async () => {
            try {
              ...
              // Common magic numbers for determining MIME type
              ...
              // Add more magic numbers as needed for other file types

              // Create a Blob from the byteArray with the determined MIME type
