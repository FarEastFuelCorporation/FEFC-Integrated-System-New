...
const AccountsPayableSidebar = ({ user }) => {
  ...
  const pathToTitleMap = useMemo(
    () => ({
      ...
      "/dashboard/transactions": "Trucking Budget Transactions",
      "/dashboard/fundTransaction": "Fund Transactions",
  ...
  return isMobile ? (
    ...
    >
      ...
      >
        ...
        />
        <BottomNavItem
          label="Trucking Budget"
          value="Trucking Budget Transactions"
      ...
      <ProSidebar collapsed={isCollapsed}>
        <Menu iconShape="square" style={{ height: "calc(100vh - 64px)" }}>
          ...
          <Box paddingLeft={isCollapsed ? undefined : "10%"}>
            ...
            />
            <Item
              title="Trucking Budget Transactions"
              to="transactions"
              icon={<PointOfSaleIcon />}
              selected={selected}
              setSelected={setSelected}
...
export default AccountsPayableSidebar;
