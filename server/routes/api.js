...
const clientAttachmentRoutes = require("./clientAttachmentRoutes");
...
const gatePassVIewRoutes = require("./gatePassVIewRoutes");
const deliveryReceiptRoutes = require("./deliveryReceiptRoutes");
const deliveryReceiptVIewRoutes = require("./deliveryReceiptVIewRoutes");
...
router.use("/deliveryReceiptView", deliveryReceiptVIewRoutes);
router.use("/gatePassView", gatePassVIewRoutes);
...
router.use("/clientAttachment", clientAttachmentRoutes);
...
router.use("/deliveryReceipt", deliveryReceiptRoutes);
